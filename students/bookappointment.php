                   ...
                   echo "<script>window.open('../studentbookappPage.php','_self')</script>";
                    ...
                    try {
                        ...
                        $message= "
													   Hello  $counsellor,
													   <br /><br />
													   This is to notify you that the student by registration number: <b> $regno</b>, name: <b> $names </b> booked an appointment on <b> $dt </b> to see you at <b> $st_tm </b>.Kindly assist.
													   <br /><br />
													   Kind Regards, <br>
